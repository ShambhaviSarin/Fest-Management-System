...
<?php
   ...
   $message = "";
      ...
      $query = "SELECT * FROM Events WHERE Category_id = 103 ";
          ...
          transform: rotate(90deg);
           ...
           <body>
            ...
            <fieldset>
              ...
              <div style = "margin-top: -58%; margin-left: -1%;; color:#fbfbfb; font-size: 30px;"><center><i>Haute Couture</i></center></div>  
                 
                 <div style = "color:bbbbbb; font-size:18px;" align = "left">
                    <center><?php echo "  $message " ?></center><br />
                 </div> 

                 <form action = "Haute_Couture.php" method = "post">
