...
<?php
   ...
   $message = "";
      ...
      $query = "SELECT * FROM Events WHERE Category_id = 102 ";
          ...
          transform: rotate(90deg);
           ...
           <body>
            ...
            <fieldset>
              ...
              <div style = "margin-top: -58%; margin-left: -1%;; color:#fbfbfb; font-size: 30px;"><center><i>Paradigm Shift</i></center></div>  
                 
                 <div style = "color:bbbbbb; font-size:18px;" align = "left">
                    <center><?php echo "  $message " ?></center><br />
                 </div> 

                 <form action = "Paradigm_Shift.php" method = "post">
                  ...
                  <div style = "margin-top: -1%; margin-left: 31%;">
