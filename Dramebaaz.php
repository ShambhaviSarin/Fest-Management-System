...
<?php
   ...
   $message = "";
      ...
      $query = "SELECT * FROM Events WHERE Category_id = 101 ";
          ...
          transform: rotate(90deg);
           ...
           <body>
            ...
            <fieldset>
              ...
              <div style = " margin-left: 83%; margin-top: -4%">
                <img src="b1.svg" id = "rot1" height = "590">
              </div>
              <div style = " margin-top: -55%; margin-left: -66%;">
                <img src="b1.svg" id = "rot" height = "590">
              </div>

              <div style = "margin-top: -57%; margin-left: -1%;; color:#fbfbfb; font-size: 30px;"><center><i>Dramebaaz</i></center></div>  
                 
                 <div style = "color:bbbbbb; font-size:18px;" align = "left">
                    <center><?php echo "  $message " ?></center><br />
                 </div> 

                 <form action = "Dramebaaz.php" method = "post">
                  <div style = "font-size: 18px; color:#fbfbfb; margin-top: 3%; " align = "center" >
