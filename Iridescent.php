...
<?php
   ...
   $message = "";
      ...
      $query = "SELECT * FROM Events WHERE Category_id = 105 ";
          ...
          transform: rotate(90deg);
           ...
           <body>
            ...
            <fieldset>
              ...
              <div style = " margin-top: -58%; margin-left: -71%;">
                <img src="b1.svg" id = "rot" height = "590">
              </div>

              <div style = "margin-top: -58%; margin-left: -1%;; color:#fbfbfb; font-size: 30px;"><center><i>Iridescent</i></center></div>  
                 
                 <div style = "color:bbbbbb; font-size:18px;" align = "left">
                    <center><?php echo "  $message " ?></center><br />
                 </div> 

                 <form action = "Iridescent.php" method = "post">
                  <div style = "font-size: 18px; color:#fbfbfb; margin-top: 4%; " align = "center" >
