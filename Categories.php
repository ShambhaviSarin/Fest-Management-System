...
<?php
   ...
   $message = "";
      ...
      if(empty($errors))
      {
         if($count > 0)
         {
            $message = "<center><table><tr> <th>Category ID&nbsp;&nbsp;&nbsp;&nbsp;</th> <th>&nbsp;&nbsp;&nbsp;&nbsp;Category Name&nbsp;&nbsp;&nbsp;&nbsp;</th> <th>&nbsp;&nbsp;&nbsp;&nbsp;Number of Events</th> </tr>";

               $message .= "<br/><tr><td>101</td>";
               $message .= "<td><a href = 'Dramebaaz.php'>Dramebaaz</a>&nbsp;&nbsp; </td>";
               $message .= "<td>&nbsp;&nbsp;5</td></tr>";

               $message .= "<br/><tr><td>102</td>";
               $message .= "<td><a href = 'Paradigm_Shift.php'>Paradigm Shift</a>&nbsp;&nbsp; </td>";
               $message .= "<td>&nbsp;&nbsp;3</td></tr>";

               $message .= "<br/><tr><td>103</td>";
               $message .= "<td><a href = 'Haute_Couture.php'>Haute Couture</a>&nbsp;&nbsp; </td>";
               $message .= "<td>&nbsp;&nbsp;1</td></tr>";

               $message .= "<br/><tr><td>104</td>";
               $message .= "<td><a href = 'Ergo.php'>Ergo</a>&nbsp;&nbsp; </td>";
               $message .= "<td>&nbsp;&nbsp;2</td></tr>";

               $message .= "<br/><tr><td>105</td>";
               $message .= "<td><a href = 'Iridescent.php'>Iridescent</a>&nbsp;&nbsp; </td>";
               $message .= "<td>&nbsp;&nbsp;4</td></tr>";
          ...
          transform: rotate(90deg);
           ...
           <body>
            ...
            <fieldset>
              ...
              <div style = " margin-top: -69%; margin-left: -95%;">
                <img src="b1.svg" id = "rot" height = "590">
              </div>

              <div style = "margin-top: -70%; margin-left: -1%;; color:#fbfbfb; font-size: 30px;"><center><i>Categories</i></center></div>  
